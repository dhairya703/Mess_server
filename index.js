...
const app = express();
const Mess = require("./mess"); // Import the Product model
...
(async () => {
    try {
        mongoose.set('strictQuery', true);
         await mongoose.connect("mongodb+srv://dhairya:dhairya703@mess.zydcclc.mongodb.net/UpdateMenu"), 
         //{
        ...
        app.post("/api/add_product", async (req, res) => {
            ...
            const data = Mess({
                pday: req.body.pday,
                pmeals: req.body.pmeals,
                // pmeal: req.body.pmeal
            });
